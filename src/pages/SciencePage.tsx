...
const SciencePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <div className="relative">
                ...
                {showSearch && (
                  <div className="absolute right-0 top-12 w-80 bg-gray-800 border border-cyan-500 rounded-lg p-4 shadow-[0_0_30px_rgba(6,182,212,0.4)]">
                    <input
                      type="text"
      ...
      {/* Footer */}
      <footer className="bg-gray-900 border-t border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.3)] relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="text-right">
              ...
              <div className="flex justify-end space-x-4">
                {/* Placeholder for social media icons - you can replace these with your images */}
